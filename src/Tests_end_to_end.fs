...
module Tests = 
    ...
    let endToEndTestListWithExpecto =
        ...
        test "End to End Test 21: Subtraction test" {
            ...
            Expect.equal ("def f x y = x - y \n f 2 3" |> tokeniser |> Parse |> Interpret ) expected "def f x y = x - y \n f 2 3"
        }
